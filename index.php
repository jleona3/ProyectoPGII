                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index.html" class="d-inline-block auth-logo">
                                    <img src="assets/misImagenes/nuevo_logo.png" alt="" height="20">
                                </a>
                            </div>
                                ...
                                <div class="p-2 mt-4">
                                    <form action="https://themesbrand.com/velzon/html/master/index.html">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="user_correo" placeholder="Ingrese Correo Electrónico">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <label class="form-label" for="password_hash">Contraseña</label>
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password" class="form-control pe-5 password-input" placeholder="Ingrese Contraseña" id="password_hash">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Trasciende La Parroquia <i class=""><br>15 avenida 07-47 zona 6, Guatemala</i>
                            </p>
                        </div>
                    </div>
                </div>
